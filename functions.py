...
def prims_initialize(graph, v):
    ...
    v : int
        The integer value of the initial vertex that will serve as the root of the minimum spanning tree
        generated by Perm's algorithm
    ...
    This function will initialize a new graph variable, add the initial vertex v to the new graph, and return the new graph.
    The return value will be a graph that contains only the initial vertex v and no edges.
    """
